      ...
      <div className={isHorizontal ? "grid grid-cols-1 items-start gap-2 lg:grid-cols-12" : "space-y-2"}>
        <div className={isHorizontal ? "space-y-2 lg:col-span-12" : "space-y-2"}>
          ...
          {publicKey && marginBalance !== null && marginBalance <= 0 && (
            <div className="rounded-lg border border-yellow-500/25 bg-yellow-500/6 px-3 py-2.5 space-y-1.5">
              <div className="flex items-start gap-2">
                ...
                <p className="text-[11px] text-yellow-400 leading-snug">
                  No margin balance. Claim devnet USDC from the faucet, then deposit it to start trading.
                </p>
              </div>
              <div className="flex gap-1.5">
                <a
