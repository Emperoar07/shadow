...
export default function MarketInfo({
  ...
  return (
    <div
      className={`trade-market-bar relative flex flex-col gap-2 bg-shadow-900 px-4 pb-[7px] pt-[6px] overflow-visible border-b border-shadow-600 sm:flex-row sm:items-center sm:gap-3 ${className}`}
    >
