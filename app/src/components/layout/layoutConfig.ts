...
export const STORAGE_KEY = "shadowperp-layout-v10";
...
export const DEFAULT_LAYOUT: Layout[] = [
  ...
  { i: "topmovers", x: 0, y: 2, w: 24, h: 1, minW: 8, minH: 1, maxH: 2 },
  { i: "chart", x: 0, y: 3, w: 14, h: 16, minW: 8, minH: 10 },
  { i: "orderbook", x: 14, y: 3, w: 5, h: 16, minW: 4, minH: 10 },
  { i: "trading", x: 19, y: 3, w: 5, h: 16, minW: 4, minH: 10 },
