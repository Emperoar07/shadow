...
use handlers::callbacks::__client_accounts_check_liquidation_v2_callback;
...
use handlers::callbacks::liquidation_callback::{CheckLiquidationV2Callback, CheckLiquidationV2Output};
...
pub mod shadowperp {
    ...
    #[arcium_callback(encrypted_ix = "check_liquidation_v2")]
    pub fn check_liquidation_v2_callback(
