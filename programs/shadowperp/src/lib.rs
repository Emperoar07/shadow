...
use handlers::callbacks::__client_accounts_check_liquidation_v3_callback;
use handlers::callbacks::__client_accounts_close_position_v3_callback;
...
declare_id!("34wszdEvGvyAVADY7ozpbdAvAB9zHRBTaT1YsNcpRJdo");
...
use handlers::callbacks::close_position_callback::{ClosePositionV3Callback, ClosePositionV3Output};
use handlers::callbacks::liquidation_callback::{CheckLiquidationV3Callback, CheckLiquidationV3Output};
...
pub mod shadowperp {
    ...
    #[arcium_callback(encrypted_ix = "close_position_v3")]
    pub fn close_position_v3_callback(
    ...
    #[arcium_callback(encrypted_ix = "check_liquidation_v3")]
    pub fn check_liquidation_v3_callback(
